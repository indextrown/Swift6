...
final class OnboardingViewModel: ObservableObject {
    ...
    init(onboardingContents: [OnboardingContent] = [
        ...
        .init(imageFileName: "onboarding_2", title: "똑똑한 나의 기록장", subTitle: "메모장으로 생각나는 기록은 언제든지"),
        .init(imageFileName: "onboarding_3", title: "하나라도 놓치지 않도록", subTitle: "T음성메모 기능으로 놓치고 싶지않은 기록까지"),
