...
// MARK: - 앱에서 UI로 보여줄 때 사용하는 안전한 모델
struct AppCat: Identifiable, Hashable {
    var id: String
    var url: String
    var bookmarkId: Int?    // 북마크된 경우만 존재
    var createdAt: String?
    
//    init(cat: Cat) {
//        self.id = cat.id ?? UUID().uuidString
//        self.url = cat.url ?? ""
//        self.bookmarkId = cat.bookmarkId
